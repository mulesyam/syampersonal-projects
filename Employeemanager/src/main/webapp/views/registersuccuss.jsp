...
<body>
	<form  method="post" action="/login" onsubmit="/profile">
		...
		<div class = "row">
			<div class = "col-md-6 col-md-offset-3">
				...
				<div class = "form-group">
						...
						placeholder="Enter Employeeid" autofocus="autofocus">
					</div> 
						...
						<div class="row">
							<div class="col-sm-6 col-sm-offset-3">
								<input type="submit"  name="login-submit" id="login-submit"
									class="form-control btn btn-primary" value="Login"  onClick="alert('Login Successfully')"/>
							</div>
						</div>
					</div>
				</form>
